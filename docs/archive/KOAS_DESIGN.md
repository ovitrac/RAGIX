---
title: "KOAS — Kernel-Orchestrated Audit System"
author: "Dr Olivier Vitrac | Adservio Innovation Lab"
creator: "Adservio"
subject: "Design Document for AI-Assisted Code Audit Platform"
keywords:
  - kernel
  - audit
  - ragix
...
<table>
  <tr>
    <td style="text-align:center;">
      <img src="MSG-HUB/v7/assets/adservio-logo.svg" alt="adservio-logo" style="zoom:60%;" />
    </td>
    <td style="text-align:center;">
      <b>KOAS — Kernel-Orchestrated Audit System<br/>Design Document | v1.0 DRAFT | 2025-12-12</b>
    </td>
  </tr>
</table>
...
KOAS (Kernel-Orchestrated Audit System) follows the **Virtual Hybrid Lab** paradigm proven in scientific computing at CARGILL, FDA, and NWO/DIFFER:
...
> *"Training a domain-specific LLM is inefficient and costly. Instead, GS uses **scientific agents**, which embed one or more LLMs and operate **scientific kernels** — specialized software libraries designed for machine-to-machine interaction."*
...
│                                                                             │
│  User: "Audit the ACME-ERP codebase and identify risks"                     │
└─────────────────────────────────────────────────────────────────────────────┘
                                      │
                    ┌─────────────────┼─────────────────┐
                    ▼                 ▼                 ▼
