...
Complete and gated. `SPEC.md` holds 127 falsifiable propositions and every one is carried by a test.
...
```
saqqara/
├── SPEC.md        the specification: 127 propositions, gates K1-K4 and K6
