...
Complete and gated. `SPEC.md` holds 152 falsifiable propositions and every one is carried by a test.
...
```
saqqara/
├── SPEC.md        the specification: 152 propositions, gates K1-K4, K6 and K7
