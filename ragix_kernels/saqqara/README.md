...
Complete and gated. `SPEC.md` holds 149 falsifiable propositions and every one is carried by a test.
...
```
saqqara/
├── SPEC.md        the specification: 149 propositions, gates K1-K4, K6 and K7
